  ...
  useEffect(() => {
    ...
    const handleScrollDown = () => {
      ...
      if (yPosOffset > getHeight) {
        ...
        document.getElementById("c1").style.transform = `translateY(${yPosOffset * 50}px) translateX(${yPosOffset * -10}px)`;
        document.getElementById("c2").style.transform = `translateY(${yPosOffset * 30}px)`;
        document.getElementById("c3").style.transform = `translateY(${yPosOffset * 30}px)`;
        document.getElementById("c4").style.transform = `translateY(${yPosOffset * 40}px) translateX(${yPosOffset * 10}px)`;
        document.getElementById("c5").style.transform = `translateY(${yPosOffset * 40}px) translateX(${yPosOffset * -10}px)`;
        document.getElementById("c6").style.transform = `translateY(${yPosOffset * 50}px)`;
      }
    };
